...
// src/host.js
var inject = ["settings"];
var SnippetSchema = Schema.object({
  items: Schema.array(Schema.object({
    id: Schema.string().required().max(LIMITS.id),
    title: Schema.string().required().max(LIMITS.title),
    content: Schema.string().required().max(LIMITS.content)
